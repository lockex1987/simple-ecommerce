 ...
 */
function notify(text: string, options = {}) {
 ...
 */
function createAlertTag(text: string, options) {
  // Nội dung thông báo
 ...
 */
function closeNotification(element: Element) {
 ...
 */
function notifyWithDefault(text: string, defaultOptionsOfType: object, options = {}) {
 ...
 */
function displayError(text: string, options?: object) {
 ...
 * @param {Object} options Config
 */
function displaySuccess(text: string, options?: object) {
  notifyWithDefault(text, {
 ...
 * @param {Object} options Config
 */
function displayInfo(text: string, options?: object) {
  notifyWithDefault(text, {
 ...
 * @param {Object} options Config
 */
function displayWarning(text: string, options?: object) {
  notifyWithDefault(text, {
 ...
 */
function displayConfirm(text: string, acceptCallback: Function, rejectCallback: Function) {
  // Vùng chứa confirm
